...
export const EVENTS: EventConfig[] = [
  {
    ...
    venue: "Gedung Sabuga, Bandung",
    hashtag: "#SarahJadiWildan",
    quota: 200,
    allowedTemplates: ["klasik", "duo", "polaroid"],
    greeting:
      "Terima kasih sudah datang. Ambil foto sebanyak yang kamu mau, lalu titip pesan suara untuk kami.",
    ...
    theme: {
      ...
      brandPurple: "#1F5C42",
      brandGold: "#D4AF37",
      brandGoldDeep: "#9C7A2E",
      fontDisplay: "var(--font-playfair)",
      decorDir: "/templates/Sarah&Wildan",
    },
  },
  {
    code: "SALMA-FAIZAL",
    ...
    hashtag: "#SalmaFaizal",
    quota: 200,
    allowedTemplates: ["sal-s1", "sal-s2", "sal-s3"],
    greeting:
  ...
  {
    code: "WISUDA-45",
    names: "Wisuda Angkatan 45",
    date: "20 September 2026",
    venue: "Aula Barat",
    hashtag: "#Wisuda45",
    quota: 100,
    allowedTemplates: ["grid", "klasik"],
    greeting: "Selamat, kalian berhasil. Abadikan dulu sebelum toga dilepas.",
    ...
    theme: {
      ...
      brandPurple: "#1B3A6B",
      brandGold: "#F2C14E",
      brandGoldDeep: "#B2862A",
      fontDisplay: "var(--font-playfair)",
      decorDir: "/templates/Wisuda45",
    },
  },
];
