...
export const TEMPLATES: Template[] = [
  ...
  {
    id: "sal-s4",
    name: "Tiga Foto Peony",
    blurb: "Tiga jepretan landscape dikelilingi rangkaian peony dan bunga liar lembut.",
    width: 941,
    height: 1672,
    printSize: '3.2 × 5.6"',
    slots: [
      { x: 130, y: 114, w: 693, h: 385 },
      { x: 130, y: 528, w: 693, h: 386 },
      { x: 130, y: 944, w: 694, h: 361 },
    ],
    overlay: "/templates/Sal&Sal/S4.png",
    paper: "#FDFEFD",
    textLayers: [],
  },
  {
    id: "sal-s5",
    name: "Dua Foto Anemone",
    blurb: "Dua jepretan besar berbingkai anemone putih dan bunga peach yang syahdu.",
    width: 941,
    height: 1672,
    printSize: '3.2 × 5.6"',
    slots: [
      { x: 117, y: 112, w: 708, h: 579 },
      { x: 117, y: 719, w: 708, h: 543 },
    ],
    overlay: "/templates/Sal&Sal/S5.png",
    paper: "#FCFAFA",
    textLayers: [],
  },
  {
    id: "sal-s6",
    name: "Dua Foto Mawar",
    blurb: "Dua jepretan hangat dalam bingkai mawar pink bersudut membulat.",
    width: 941,
    height: 1672,
    printSize: '3.2 × 5.6"',
    slots: [
      { x: 119, y: 169, w: 704, h: 463 },
      { x: 119, y: 715, w: 704, h: 457 },
    ],
    overlay: "/templates/Sal&Sal/S6.png",
    paper: "#FEE9E5",
    textLayers: [],
  },
  {
    id: "sal-s7",
    name: "Tiga Foto Pita",
    blurb: "Tiga jepretan manis dihiasi pita-pita pink yang playful.",
    width: 941,
    height: 1672,
    printSize: '3.2 × 5.6"',
    slots: [
      { x: 189, y: 214, w: 575, h: 336 },
      { x: 189, y: 581, w: 575, h: 333 },
      { x: 189, y: 946, w: 576, h: 313 },
    ],
    overlay: "/templates/Sal&Sal/S7.png",
    paper: "#FDF3EB",
    textLayers: [],
  },
];
